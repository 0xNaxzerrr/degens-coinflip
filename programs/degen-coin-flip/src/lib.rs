...
declare_id!("BLW2czkQvfXUJFFNovX6BJgpikGx86xqdUuZyoBiX1GW");
...
pub mod coinflip {
    ...
    pub fn place_bet(
        ...
        if won {
            ...
            let escrow_seeds = &[b"escrow".as_ref(), &[ctx.accounts.game_state.bump]];
            ...
            msg!(
                "Player won! The result was {}. Transferred {} SOL to player",
                result_text,
                winnings as f64 / LAMPORTS_PER_SOL as f64
            );
        } else {
            msg!(
                "Player lost! The result was {}. Better luck next time.",
                result_text
            );
        }
...
#[derive(Accounts)]
#[instruction(amount: u64, user_choice: u8, bet_id: u64)]
